<template>
  <div class="admin-class-attendance-page">
    <el-card class="content">
      ...
      <el-col :span="8">
        ...
        <div style="padding-top: 30px;text-align: center;" v-if="courseStatus !== '3'">
...
<script>
  ...
  export default {
    title: '出勤签到',
    name: 'admin-class-attendance-pagee',
    components: {
      IconFont
    },
    data() {
...
<style>
  .admin-class-attendance-page .content {
    min-width: 1100px;
    overflow-x: auto;
    min-height: 900px;
  }
  .admin-class-attendance-page .content .el-row {
    margin-bottom: 20px;
    &:last-child {
      margin-bottom: 0;
    }
  ...
  .admin-class-attendance-page .chenk-box .el-checkbox__input {
    display: none;
  }
  ...
  .admin-class-attendance-page .seat-icon .icon {
    color: #606266;
  }
  .admin-class-attendance-page .seat-icon .icon-selected {
    /*color: #409EFF;*/
  }
