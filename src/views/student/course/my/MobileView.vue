...
<style>
  ...
  .mobile-home-student-class-my .list-item:last-child {
    border-bottom: 0;
  }
  .mobile-home-student-class-my .content {
    /*padding: 15px;*/
  }
  ...
  .mobile-home-student-class-my .seat-icon {
    width: 90px;
    text-align: center;
    padding-top: 15px;
  }
  .mobile-home-student-class-my .seat-icon .icon {
    color: #606266;
  }
  .mobile-home-student-class-my .seat-icon .icon-selected {
    /*color: #409EFF;*/
  }
  .mobile-home-student-class-my .el-checkbox__label {
    padding-left: 0;
