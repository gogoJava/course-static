...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {path: 'student/class/all', meta: {title: '全部课程'}, component: () => import('../views/student/course/list/view.vue')},
      {path: 'class/order/pay', meta: {title: '课程支付'}, component: () => import('../views/student/course/order/view.vue')},
